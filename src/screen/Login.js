...
function Login({navigation, ...props}) {
  ...
  return (
    <LinearGradient colors={['#FFF3EE', '#FFFFFF']} style={[{flex: 1}]}>
      <View style={[t.wp100, t.px20, t.py20, t.brtl10, t.brtr10, t.fjCenter, t.hp100]}>
        <Text style={[t['h24-700'], t.cblack]}>
          Welcome Back!
        </Text>
        <Text style={[t['p14-400'], t.cgrey9]}>
        ...
        <View style={[t.mt100, t.fRow, t.fjCenter]}>

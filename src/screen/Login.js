  ...
  return (
    <KeyboardAvoidingView
      ...
      <View style={[t.wp100, t.mt50]}>
        ...
        <Text style={[t.cblue_grey, t['p14-500'], t.tCenter]}>
        ...
        <View style={[t.bgblack, t.px50, t.wp100, t.mt15, t.br12]}>
          ...
          <TouchableOpacity
            ...
            style={[t.absolute, t.right20, t.top15]}>
            <Icon
        ...
        <TouchableOpacity
          style={[t.bgyellow, t.faCenter, t.py15, t.br52, t.mt20]}
          onPress={() => {
            doLogin();
          }}
          disabled={loading ? true : false}>
          <Text style={[t['p14-500'], t.cblack]}>
            {loading ? 'Processing...' : 'Login'}
          </Text>
        </TouchableOpacity>
        {!login.status ? (
          <Text style={[t.cindian_red, t['p10-400'], t.tCenter, t.pt5]}>
            {login.msg}
          </Text>
        ) : null}
        ...
        <View style={[t.relative, t.mt30, t.faCenter]}>
          <TouchableOpacity
            ...
            <Text style={[t.cwhite, t['p15-500'], t.me5]}>

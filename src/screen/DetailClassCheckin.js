...
const DetailClassCheckin = ({ route, navigation }) => {
    ...
    <View style={[t.bgwhite, { flex: 1 }]}>
          ...
          <View style={[t.p20, t.pt50, t.fjBetween, t.absolute, t.top0, t.bottom0, t.left0, t.right0, { backgroundColor: 'rgba(0,0,0,0.3)' }]}>
            <View style={[t.fRow, t.faCenter, t.fjBetween]}>
              ...
              <View style={[{ backgroundColor: '#ECF0EE' }, t.px12, t.py6, t.br5]}>
                <Text style={[{ color: '#3F6050' }, t['h12-400']]}>{theClass?.level || 'CLASSES'}</Text>
              </View>
            </View>
            <View>
      ...
      <View style={[t.px20, t.pb30, t.pt10, t.bgwhite]}>
        <TouchableOpacity style={[t.bgneworange, t.py10, t.br10, t.faCenter, t.fRow, t.fjCenter]}>
          <Text style={[t.cwhite, t['h14-600']]}>Check-In Now</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[t.mt15, t.faCenter, t.fRow, t.br10, t.fjCenter, t.py10, t.bw1, t.bsolid, t.bblack]}>
          <Text style={[t.cblack, t['h14-600']]}>Cancel Booking</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
export default DetailClassCheckin;
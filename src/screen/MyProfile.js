...
const MyProfile = ({navigation}) => {
  ...
  const profileimage = user
    ? {uri: 'https://api.yogafitidonline.com/api/storage/foto/' + user.foto}
  ...
  const doChangePassword = async () => {
    setloading(true);
    try {
      if (new_password == confirmasi_password) {
        let payload = {
  ...
  return (
    <ScrollView style={[t.bgwhite]}>
      ...
      />
      <KeyboardAvoidingView style={[t.pt50, t.px20, t.faCenter, t.fjCenter]}>
        <Theimage
          original={profileimage}
          placeholder={img.profile}
          style={[t.w150, t.h150, {objectFit: 'contain'}]}
        />
        <View
          style={[
            t.fRow,
        ...
        <View
          ...
          <Text style={[t['p14-700'], t.cblack]}>
            {user && Helper.dateIndo(user.date_birth)}
          </Text>
        </View>
        ...
        <View style={[t.mt20]}>
          ...
          <View style={[t.fRow, t.fjBetween, t.faCenter, t.wp100, t.relative]}>
            <TextInput
              ...
              secureTextEntry={shownew_password ? false : true}
            />
            <Pressable
              ...
              <Image
                source={shownew_password ? img.eyeopen : img.eyeclose}
                style={[t.w20, t.h20]}
              />
            </Pressable>
          </View>
        ...
        <View style={[t.mt20]}>
          ...
          <View style={[t.fRow, t.fjBetween, t.faCenter, t.wp100, t.relative]}>
            <TextInput
              onChangeText={setconfirmasi_password}
              value={confirmasi_password}
              placeholderTextColor="#ccc"
              placeholder="Rernter your new password"
              style={[
                t.bggrey90,
                t.p10,
                t['p14-500'],
              ...
              secureTextEntry={showconfirmasi_password ? false : true}
            />
            <Pressable
              style={[t.absolute, t.right10, t.top25]}
              onPress={() => {
                setshowconfirmasi_password(!showconfirmasi_password);
              }}>
              <Image
                source={showconfirmasi_password ? img.eyeopen : img.eyeclose}
                style={[t.w20, t.h20]}
              />
            </Pressable>
          </View>

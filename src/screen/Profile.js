    ...
    <ScrollView style={[t.bgwhite]}>
      ...
      <View style={[t.pt70, t.px20, t.faCenter, t.fjCenter]}>
        <Theimage
          ...
          style={[t.w50, t.h50, {objectFit: 'contain'}]}
        />
        <Text style={[t['p18-700'], t.corange, t.mt10]}>
          {user && user.name}
        </Text>
        <Text style={[t['p18-600'], t.cblack, t.mt5]}>
          {user && user.email}
        </Text>
      </View>
      <View style={[t.px20, t.mt20]}>
        <TouchableOpacity
          ...
          <Image
            source={img.share}
            style={[t.w30, t.h30, {objectFit: 'contain'}]}
          />
        </TouchableOpacity>
      </View>
      ...
      {booking.length > 0 && (
        <View style={[t.mt20, t.px20]}>
          <TouchableOpacity
            ...
            <Text
              style={[t.bgorange, t['h30-400'], t.cwhite, t.py15, t.tCenter]}>
              Booking History
            </Text>
            <View style={[t.fRow, t.faCenter, t.p10, t.fjCenter, t.bgwarning]}>
              <Image
                source={img.navClassActive}
                style={[t.w30, t.h30, {objectFit: 'contain'}]}
              />
              <Text style={[t['h30-400'], t.corange, t.ms10]}>
                {booking.length}
              </Text>
      ...
      {contract && (
        <View style={[t.mt20, t.px20]}>
          <View
            ...
            <Image
              source={img.ticketOrange}
              style={[t.w40, t.h40, {objectFit: 'contain'}]}
            />
            <View style={[t.ms10]}>
              ...
              <View style={[t.fRow, t.faCenter, t.fjBetween, t.wp92]}>
                <View style={[t.fRow, t.faCenter]}>
                  ...
                  <Text style={[t['p10-600'], t.corange]}>
                    {contract && Helper.dateFormatId(contract.start_date)}
                  </Text>
                </View>
                <View style={[t.fRow, t.faCenter]}>
                  <Text style={[t['p10-600'], t.cblack]}>End Date: </Text>
                  <Text style={[t['p10-600'], t.corange]}>
                    {contract && Helper.dateFormatId(contract.end_date)}
                  </Text>
                </View>
              </View>
            </View>

  ...
  return (
    <View style={[t.wp100,t.fRow,t.fjBetween,t.faCenter]}>
      <View style={[t.fRow,t.wp45,t.faCenter,t.br10,t.bw1,t.bsolid,t.bgreyd,t.bgwhite,t.p10]}>
        <TouchableOpacity style={[t.fRow]} onPress={() => {navigation.navigate('Class',{classKat: 'normal'})}}>
      ...
      <View style={[t.fRow,t.wp45,t.faCenter,t.br10,t.bw1,t.bsolid,t.bgreyd,t.bgwhite,t.p10]}>
        <TouchableOpacity style={[t.fRow]} onPress={() => {navigation.navigate('Class',{classKat: 'hot'})}}>

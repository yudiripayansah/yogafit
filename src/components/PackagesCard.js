    ...
    <Pressable
      ...
      <View style={[t.relative, boxStyle]}>
        <View style={[t.fRow, t.faCenter, t.fjBetween]}>
          ...
          <Text style={[t['p12-600'], t.cblack, t.mt10]}>
        ...
        <View style={[t.fRow, t.faCenter, t.fjBetween]}>
          ...
          <Text style={[t['p12-600'], t.cblack, t.mt10]}>
            {data && data.typeMember}
          </Text>
        </View>
        <View style={[t.fRow, t.faCenter, t.fjBetween]}>
          <Text style={[t['p12-600'], t.cgreya, t.mt10]}>Start Date</Text>
          <Text style={[t['p12-600'], t.cblack, t.mt10]}>
            {data && Helper.dateIndo(data.start_date)}
          </Text>
        </View>
        <View style={[t.fRow, t.faCenter, t.fjBetween]}>
          <Text style={[t['p12-600'], t.cgreya, t.mt10]}>End Date</Text>
          <Text style={[t['p12-600'], t.cblack, t.mt10]}>
            {data && Helper.dateIndo(data.end_date)}
          </Text>
        </View>
        <View style={[t.fRow, t.faCenter, t.fjBetween]}>
          <Text style={[t['p12-600'], t.cgreya, t.mt10]}>
            Total Used Session
          </Text>
          <Text style={[t['p12-600'], t.cblack, t.mt10]}>

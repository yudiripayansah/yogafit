  ...
  return (
    <ActionSheet ref={forgotRef}>
      <View style={[t.bgwhite,t.wp100,t.px20,t.py20,t.brtl10,t.brtr10]}>
        <TouchableOpacity onPress={() => forgotRef.current?.hide()} style={[t.msAuto]}>
        ...
        <View style={[t.mt20]}>
          ...
          <TextInput onChangeText={setphone} value={phone} placeholderTextColor='#ccc' placeholder='eg: +6281234567890' style={[t.bggrey90,t.p10,t['p14-500'],t.br5,t.cwhite,t.mt10]}/>
        </View>
        ...
        <TouchableOpacity style={[t.mxAuto,t.bgorange,t.faCenter,t.fjCenter,t.px50,t.py10,t.br5]} onPress={() => {doforgot()}}>
          <Text style={[t['p14-700'],t.cblack]}>{loading ? 'Processing...' : 'Submit'}</Text>
        </TouchableOpacity>
        <View style={[t.faCenter,t.fjCenter,t.mt5]}>
          <Text style={[t['p12-500'],forgot.status ? t.cblack : t.cdanger]}>{forgot.msg}</Text>
        </View>
      </View>
    </ActionSheet>
  );

  ...
  return (
    <Pressable
      onPress={() => {
        onPress({
          uri: data
            ? 'https://login.yogafitindonesiaonline.com/api/storage/qrcode/' +
              data.referal_code +
              '.png'
            : 'xxx',
        });
      ...
      <View style={[t.fRow, t.fjBetween, t.faStart, t.mt10]}>
        ...
        <View style={[t.px10, t.py5, t.bgorange, t.br5]}>
          <Text style={[t['p10-500'], t.cwhite, t.tCenter, t.mb5]}>
            Scan QR
          </Text>
          <Theimage
            original={{
            ...
            style={[t.w80, t.h80, {objectFit: 'contain'}]}
          />
          <Text style={[t['p10-500'], t.cwhite, t.tCenter, t.mt5]}>
            Klik Disini
          </Text>
        </View>
      </View>

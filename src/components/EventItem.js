...
function ClassItem({navigation, ...props}) {
  ...
  return (
    <View style={[t.br10,t.relative,{overflow:'hidden'},boxStyle]}>
      <Image source={data.image} style={[t.wp100,t.h200,t.br10,{objectFit:'cover'}]}/>
      ...
      <View style={[t.fRow,t.fjBetween,t.faCenter,t.mt10,t.absolute,t.bottom0,t.left0,t.wp100,t.p10]}>
        <View style={[t.pe20]}>
          <Text style={[t['p18-700'],t.cwhite]}>{data.name}</Text>
          <Text style={[t['p12-600'],t.cwhite]}>{data.date}</Text>
        </View>
        <TouchableOpacity>

...
function ChangePhone({navigation, ...props}) {
  ...
  const doChange = async () => {
    ...
    try {
      ...
      console.error('Error change phone number: ' + error);
      setCp({
        status: false,
  ...
  return (
    <ActionSheet ref={changephoneRef}>
      <View style={[t.bgwhite, t.wp100, t.px20, t.py20, t.brtl10, t.brtr10]}>
        <TouchableOpacity
          onPress={() => changephoneRef.current?.hide()}
          style={[t.msAuto]}>
        ...
        <View style={[t.mt10, t.fRow, t.wp100]}>
          <Text style={[t['p12-500'], t.cblack, t.tCenter, t.wp100]}>
            Hi {registerdata.name}, Please enter new phone number
          </Text>
        </View>
        <View style={[t.mt20, t.faCenter, t.fjCenter, t.wp100]}>
          <TextInput
            ...
            style={[t.bggrey90, t.p10, t['p14-500'], t.br5, t.cwhite, t.wp80]}
          />
        </View>
        <View style={[t.faCenter, t.fjCenter]}>
          ...
          <View style={[t.faCenter, t.fjCenter, t.mt5]}>
            <Text style={[t['p12-500'], cp.status ? t.cblack : t.cdanger]}>
              {cp.msg}
            </Text>
          </View>
        </View>
